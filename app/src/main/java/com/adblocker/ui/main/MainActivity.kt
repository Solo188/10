 ...
 *
 * Single-screen UI:
 *   • Large shield toggle button (Start / Stop VPN)
 *   • Status chip showing current VPN state
 *   • Live RecyclerView of intercepted/blocked requests
 *   • Overflow menu: Export CA cert, Clear log, About
 */
